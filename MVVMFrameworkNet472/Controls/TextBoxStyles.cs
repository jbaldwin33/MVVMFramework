...
using static MVVMFrameworkNet472.Controls.TextBoxUtilities;

namespace MVVMFrameworkNet472.Controls
{
    ...
    public abstract class DefaultTextBox : TextBox
    {
        protected DefaultTextBox()
        {
            ...
            {
                Source = new Uri("/MVVMFrameworkNet472;component/Controls/ControlStyles.xaml", UriKind.RelativeOrAbsolute)
            };
